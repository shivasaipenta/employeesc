					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "custom emp app",
									"targetURL": "#employeesc-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"employeesc-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=employeesc",
									"url": sap.ui.require.toUrl("employeesc")
								}
							}
						}
					}
